...
import newAdjustments from './functions/create-adjustments';
...
const confirm = await inquirer.prompt({
    type: 'confirm',
    name: 'confirm',
    message: `So, you want to make adjustment(s) for \x1b[33m${answer1.indicies.join(', ')}\x1b[0m on \x1b[32m${localeDate}\x1b[0m`
})
